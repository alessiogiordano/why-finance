...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteUser = channel.unary_unary(
                ...
                request_serializer=user__pb2.UserDeletionRequest.SerializeToString,
                response_deserializer=user__pb2.UserResponse.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteUser': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteUser,
                    request_deserializer=user__pb2.UserDeletionRequest.FromString,
                    response_serializer=user__pb2.UserResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def DeleteUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user.UserService/DeleteUser',
            user__pb2.UserDeletionRequest.SerializeToString,
            user__pb2.UserResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
